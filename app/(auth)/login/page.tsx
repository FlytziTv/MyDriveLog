    ...
    <div className="min-h-screen px-6 py-8">
      ...
      <div className="flex flex-col items-start gap-8 mb-8">
        ...
        <div className="flex flex-col items-start gap-0">
          <h1 className="text-[28px] font-bold text-neutral-900">Connexion</h1>
      ...
      <div className="flex flex-col gap-4">
        ...
        <button className="text-xs hover:underline underline-offset-2 text-neutral-900 ml-auto block font-medium">
          Mot de passe oublié ?
        </button>
