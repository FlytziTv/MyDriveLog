-- CreateEnum
CREATE TYPE "MaintenanceType" AS ENUM ('OIL_CHANGE', 'TIRE_CHANGE', 'REVISION', 'BRAKE', 'BATTERY', 'BELT', 'FILTER', 'CONTROL', 'OTHER');

-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('FUEL', 'INSURANCE', 'PARKING', 'TOLL', 'FINE', 'WASH', 'OTHER');
